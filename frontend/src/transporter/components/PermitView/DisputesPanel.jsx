...
import { AlertTriangle, CheckCircle, X, Plus, ShieldAlert } from 'lucide-react';
...
export function DisputesPanel({ flags, permitNumber, onRefresh }) {
  ...
  const handleWithdraw = async (flagId) => {
    ...
    catch (e) {setActionError(e.message || 'Failed to withdraw flag');} finally
    {setBusy(null);}
  };
  ...
  const handleRaise = async () => {
    ...
    } catch (e) {setError(e.message || 'Failed to raise flag');} finally
    {setBusy(null);}
  };
