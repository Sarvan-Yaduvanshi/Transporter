...
const emptyForm = { loadId: '', permitNumber: '', truckNumber: '', currentStage: 'CREATED', hasFlag: false };
...
export function PastLoadsView() {
  ...
  const handleSave = async () => {
    ...
    try {
      if (editingLoad) {
        await updateLoad(editingLoad, { permitNumber: form.permitNumber.trim(), truckNumber: form.truckNumber.trim(), currentStage: form.currentStage, hasFlag: form.hasFlag });
      } else {
