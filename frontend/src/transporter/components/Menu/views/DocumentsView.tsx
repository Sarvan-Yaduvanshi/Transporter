...
import {
    ...
    type DriverDocument, type Driver, type Truck,
} from '@/services/api';
...
export function DocumentsView() {
    const [filterType, setFilterType] = useState<'' | 'Driver' | 'Truck'>('');
                            ...
                            {!editingDoc && (
                                <>
                                    <div>
                                        ...
                                        <select value={form.ownerType} onChange={e => setForm(f => ({ ...f, ownerType: e.target.value as 'Driver' | 'Truck', ownerId: '', docType: e.target.value === 'Driver' ? PERSONAL_DOC_TYPES[0] : TRUCK_DOC_TYPES[0] }))}
