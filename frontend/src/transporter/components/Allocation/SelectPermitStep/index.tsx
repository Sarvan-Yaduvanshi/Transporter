...
import type { Permit } from '@/services/api';

interface SelectPermitStepProps {
    onSelect: (permit: string) => void;
}

export function SelectPermitStep({ onSelect }: SelectPermitStepProps) {
