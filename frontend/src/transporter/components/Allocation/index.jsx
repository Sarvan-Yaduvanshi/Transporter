...
const STEP_KEYS = ['select-permit', 'post-capacity', 'tag-trucks', 'feedback'];

export function Allocation({ onNavigateToPermit }) {
  const [step, setStep] = useState('select-permit');
  const [selectedPermit, setSelectedPermit] = useState(null);
  const [capacity, setCapacity] = useState('');
  const [taggedTrucks, setTaggedTrucks] = useState([]);
