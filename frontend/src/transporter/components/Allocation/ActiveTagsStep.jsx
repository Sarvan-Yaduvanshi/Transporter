...
export function ActiveTagsStep({ onBack, onNavigate }) {
  ...
  const handleCancel = async (id) => {
    ...
    catch (e) {alert(e.message || 'Failed to cancel tag');} finally
    {setBusy(null);}
  };
  ...
  const handleDelete = async (id) => {
    ...
    catch (e) {alert(e.message || 'Failed to remove tag');} finally
    {setBusy(null);}
  };
