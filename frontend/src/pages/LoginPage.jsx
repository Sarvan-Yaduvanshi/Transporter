...
// triggerGoogleOAuth removed — Google login now uses Firebase via useAuth
// Facebook login uses Firebase in useAuth; legacy OAuth removed
        ...
        <div className="w-full max-w-md">
          ...
          {mode === 'phone' && phoneStep === 'otp' && (
            <div className="space-y-5">
              <div>
                <button
                  onClick={() => { setPhoneStep('enter'); setError(''); }}
