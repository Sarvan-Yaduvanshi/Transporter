...
import { type DriverDocument } from '@/services/api';
import { useSync } from '@/hooks/SyncContext';

interface TruckHealthProps {
    truckNumber: string;
    onBack: () => void;
}

/* Map document status to a display status including "Expiring Soon" */
function docHealthStatus(doc: DriverDocument): string {
...
export function TruckHealth({ truckNumber, onBack }: TruckHealthProps) {
