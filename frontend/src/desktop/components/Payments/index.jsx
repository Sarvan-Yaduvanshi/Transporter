...
export function PaymentsPage({ initialPermit, onClearInitialPermit }) {
  const [selectedPermit, setSelectedPermit] = useState(initialPermit ?? null);
  ...
  const handleViewInvoice = (permitNumber) => setSelectedPermit(permitNumber);
